...
const en = {
  ...
  admin: {
    ...
    pluginPage: {
      ...
      errorLoading: "Failed to load plugin page",
      unknownPage: "Unknown plugin page",
      noDocuments: "No items yet.",
      createItem: "Create",
      editItem: "Edit",
      deleteItem: "Delete",
    ...
    tenantBot: {
      ...
      tokenUnchanged: "Leave blank to keep the current token",
      tokenHint: "A token is already stored. Leave blank to keep it unchanged.",
      cabinetUrl: "Cabinet URL",
      plugin: "Bot Plugin",
      defaultPlugin: "Cabinet Bot (default)",
      enabled: "Enabled",
      disabled: "Disabled",
      saveSuccess: "Bot configuration saved.",
    },
    nodes: {
      title: "Nodes",
...
const ru: typeof en = {
  ...
  admin: {
    ...
    plugins: {
      ...
      pages: "Страницы плагинов",
    },
    pluginPage: {
      loading: "Загрузка страницы...",
      errorLoading: "Не удалось загрузить страницу плагина",
      unknownPage: "Неизвестная страница плагина",
      noDocuments: "Пока нет элементов.",
      createItem: "Создать",
    ...
    tenantBot: {
      title: "Telegram Bot",
      token: "Токен бота",
      tokenPlaceholder: "Введите токен бота от @BotFather",
      tokenUnchanged: "Оставьте пустым, чтобы сохранить текущий токен",
      tokenHint:
        "Токен уже сохранён. Оставьте поле пустым, чтобы не менять его.",
      cabinetUrl: "URL кабинета",
      plugin: "Плагин бота",
      defaultPlugin: "Cabinet Bot (по умолчанию)",
      enabled: "Включён",
      disabled: "Выключен",
      saveSuccess: "Конфигурация бота сохранена.",
    },
    nodes: {
      title: "Ноды",
