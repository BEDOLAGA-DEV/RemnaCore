...
const en = {
  ...
  admin: {
    ...
    tariffs: {
      ...
      maxPurchasesPerUser: "Max purchases per user",
      internalSquadUuids: "Internal squad UUIDs",
      externalSquadUuids: "External squad UUIDs",
      features: "Features",
      active: "Active",
      inactive: "Inactive",
      ...
      commaSeparated: "Comma-separated UUIDs",
...
const ru: typeof en = {
  ...
  admin: {
    ...
    tariffs: {
      ...
      maxPurchasesPerUser: "Макс. покупок на пользователя",
      internalSquadUuids: "Внутренние UUID отрядов",
      externalSquadUuids: "Внешние UUID отрядов",
      ...
      squads: "Отряды",
      deleteConfirm: "Вы уверены, что хотите удалить этот тариф?",
      commaSeparated: "UUID через запятую",
