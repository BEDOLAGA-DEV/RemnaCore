...
func remnawaveRoutes() []plugin.ManifestRoute {
	return []plugin.ManifestRoute{
		...
		{Method: "POST", Path: "/api/remnawave/panels/{panelID}/test", Function: "test_panel", Public: false},
		{Method: "POST", Path: "/api/remnawave/panels/{panelID}/maintenance", Function: "set_panel_maintenance", Public: false},
		{Method: "GET", Path: "/api/remnawave/panels/{panelID}/stats", Function: "get_panel_stats", Public: false},
		{Method: "PUT", Path: "/api/remnawave/panels/{panelID}", Function: "update_panel", Public: false},
		{Method: "DELETE", Path: "/api/remnawave/panels/{panelID}", Function: "delete_panel", Public: false},

		// --- Nodes ---
		{Method: "GET", Path: "/api/remnawave/nodes", Function: "list_nodes", Public: false},
		{Method: "POST", Path: "/api/remnawave/nodes/bulk/{panelID}", Function: "bulk_node_action", Public: false},
		{Method: "GET", Path: "/api/remnawave/nodes/{panelID}/{nodeUUID}", Function: "get_node", Public: false},
		{Method: "POST", Path: "/api/remnawave/nodes/{panelID}/{nodeUUID}/restart", Function: "restart_node", Public: false},
		{Method: "POST", Path: "/api/remnawave/nodes/{panelID}/{nodeUUID}/disable", Function: "disable_node", Public: false},
		{Method: "POST", Path: "/api/remnawave/nodes/{panelID}/{nodeUUID}/enable", Function: "enable_node", Public: false},
		{Method: "GET", Path: "/api/remnawave/nodes/{panelID}/{nodeUUID}/stats", Function: "get_node_stats", Public: false},
		{Method: "GET", Path: "/api/remnawave/nodes/{panelID}/{nodeUUID}/health", Function: "get_node_health", Public: false},
		{Method: "GET", Path: "/api/remnawave/nodes/{panelID}/{nodeUUID}/users", Function: "get_node_users", Public: false},

		// --- Users ---
		{Method: "GET", Path: "/api/remnawave/users", Function: "search_users", Public: false},
		{Method: "GET", Path: "/api/remnawave/users/{panelID}/{userUUID}", Function: "get_user", Public: false},
		{Method: "PUT", Path: "/api/remnawave/users/{panelID}/{userUUID}", Function: "update_user", Public: false},
		{Method: "POST", Path: "/api/remnawave/users/{panelID}/{userUUID}/reset-traffic", Function: "reset_user_traffic", Public: false},
		{Method: "POST", Path: "/api/remnawave/users/{panelID}/{userUUID}/revoke-subscription", Function: "revoke_user_subscription", Public: false},
		{Method: "POST", Path: "/api/remnawave/users/{panelID}/{userUUID}/disconnect", Function: "disconnect_user", Public: false},
		{Method: "GET", Path: "/api/remnawave/users/{panelID}/{userUUID}/sessions", Function: "get_user_sessions", Public: false},
		{Method: "GET", Path: "/api/remnawave/users/{panelID}/{userUUID}/hwid", Function: "get_user_hwid", Public: false},
		{Method: "DELETE", Path: "/api/remnawave/users/{panelID}/{userUUID}/hwid/{hwidID}", Function: "delete_user_hwid", Public: false},
		{Method: "GET", Path: "/api/remnawave/users/{panelID}/{userUUID}/subscription-url", Function: "get_user_subscription_url", Public: false},

		// --- Squads ---
		{Method: "GET", Path: "/api/remnawave/squads/internal", Function: "list_internal_squads", Public: false},
		{Method: "GET", Path: "/api/remnawave/squads/external", Function: "list_external_squads", Public: false},
		{Method: "POST", Path: "/api/remnawave/squads/{panelID}", Function: "create_squad", Public: false},
		{Method: "POST", Path: "/api/remnawave/squads/{panelID}/{squadUUID}/add-nodes", Function: "add_nodes_to_squad", Public: false},
		{Method: "POST", Path: "/api/remnawave/squads/{panelID}/{squadUUID}/remove-nodes", Function: "remove_nodes_from_squad", Public: false},
		{Method: "POST", Path: "/api/remnawave/squads/{panelID}/reorder", Function: "reorder_squad", Public: false},
		{Method: "PUT", Path: "/api/remnawave/squads/{panelID}/{squadUUID}", Function: "update_squad", Public: false},
		{Method: "DELETE", Path: "/api/remnawave/squads/{panelID}/{squadUUID}", Function: "delete_squad", Public: false},

		// --- Dashboard & Analytics ---
		{Method: "GET", Path: "/api/remnawave/dashboard/overview", Function: "get_dashboard_overview", Public: false},
		{Method: "GET", Path: "/api/remnawave/dashboard/realtime", Function: "get_dashboard_realtime", Public: false},
		{Method: "GET", Path: "/api/remnawave/analytics/traffic-top-users", Function: "get_traffic_top_users", Public: false},
		{Method: "GET", Path: "/api/remnawave/analytics/traffic-by-node", Function: "get_traffic_by_node", Public: false},
		{Method: "GET", Path: "/api/remnawave/analytics/traffic-by-country", Function: "get_traffic_by_country", Public: false},
		{Method: "GET", Path: "/api/remnawave/analytics/bandwidth-trends", Function: "get_bandwidth_trends", Public: false},
		{Method: "GET", Path: "/api/remnawave/analytics/user-retention", Function: "get_user_retention", Public: false},
		{Method: "GET", Path: "/api/remnawave/analytics/hwid-distribution", Function: "get_hwid_distribution", Public: false},
		{Method: "GET", Path: "/api/remnawave/analytics/client-app-distribution", Function: "get_client_app_distribution", Public: false},

		// --- Drift & Reconciliation ---
		{Method: "GET", Path: "/api/remnawave/drift/events", Function: "list_drift_events", Public: false},
		{Method: "POST", Path: "/api/remnawave/drift/reconcile", Function: "trigger_reconciliation", Public: false},
		{Method: "POST", Path: "/api/remnawave/drift/events/{eventID}/resolve", Function: "resolve_drift_event", Public: false},
		{Method: "POST", Path: "/api/remnawave/drift/events/{eventID}/heal", Function: "heal_drift_event", Public: false},

		// --- Geo Routing ---
		{Method: "GET", Path: "/api/remnawave/routing/rules", Function: "list_routing_rules", Public: false},
		{Method: "POST", Path: "/api/remnawave/routing/rules", Function: "create_routing_rule", Public: false},
		{Method: "POST", Path: "/api/remnawave/routing/simulate", Function: "simulate_routing", Public: false},
		{Method: "PUT", Path: "/api/remnawave/routing/rules/{ruleID}", Function: "update_routing_rule", Public: false},
		{Method: "DELETE", Path: "/api/remnawave/routing/rules/{ruleID}", Function: "delete_routing_rule", Public: false},

		// --- Nodes expanded ---
		{Method: "POST", Path: "/api/remnawave/nodes/{panelID}", Function: "create_node", Public: false},
		{Method: "PATCH", Path: "/api/remnawave/nodes/{panelID}", Function: "update_node", Public: false},
		{Method: "DELETE", Path: "/api/remnawave/nodes/{panelID}/{nodeUUID}", Function: "delete_node", Public: false},
		{Method: "POST", Path: "/api/remnawave/nodes/{panelID}/{nodeUUID}/reset-traffic", Function: "reset_node_traffic", Public: false},
		{Method: "POST", Path: "/api/remnawave/nodes/{panelID}/restart-all", Function: "restart_all_nodes", Public: false},
		{Method: "POST", Path: "/api/remnawave/nodes/{panelID}/reorder", Function: "reorder_nodes", Public: false},
		{Method: "GET", Path: "/api/remnawave/nodes/{panelID}/tags", Function: "get_node_tags", Public: false},
		{Method: "GET", Path: "/api/remnawave/nodes/{panelID}/system-info", Function: "get_system_info", Public: false},

		// --- Users expanded ---
		{Method: "POST", Path: "/api/remnawave/users/{panelID}/{userUUID}/enable", Function: "enable_user", Public: false},
		{Method: "POST", Path: "/api/remnawave/users/{panelID}/{userUUID}/disable", Function: "disable_user", Public: false},
		{Method: "DELETE", Path: "/api/remnawave/users/{panelID}/{userUUID}", Function: "delete_user", Public: false},
		{Method: "GET", Path: "/api/remnawave/users/{panelID}/tags", Function: "get_user_tags", Public: false},
		{Method: "GET", Path: "/api/remnawave/users/{panelID}/{userUUID}/bandwidth", Function: "get_user_bandwidth", Public: false},
		{Method: "GET", Path: "/api/remnawave/users/{panelID}/ip-fetch-result/{jobID}", Function: "get_ip_fetch_result", Public: false},

		// --- Hosts ---
		{Method: "GET", Path: "/api/remnawave/hosts", Function: "list_hosts", Public: false},
		{Method: "GET", Path: "/api/remnawave/hosts/{panelID}/{hostUUID}", Function: "get_host", Public: false},
		{Method: "POST", Path: "/api/remnawave/hosts/{panelID}", Function: "create_host", Public: false},
		{Method: "PATCH", Path: "/api/remnawave/hosts/{panelID}", Function: "update_host", Public: false},
		{Method: "DELETE", Path: "/api/remnawave/hosts/{panelID}/{hostUUID}", Function: "delete_host", Public: false},
		{Method: "POST", Path: "/api/remnawave/hosts/{panelID}/reorder", Function: "reorder_hosts", Public: false},
		{Method: "GET", Path: "/api/remnawave/hosts/{panelID}/tags", Function: "get_host_tags", Public: false},
		{Method: "POST", Path: "/api/remnawave/hosts/{panelID}/bulk", Function: "bulk_host_action", Public: false},

		// --- Users bulk ---
		{Method: "POST", Path: "/api/remnawave/users/bulk/{panelID}/delete-by-status", Function: "bulk_delete_users_by_status", Public: false},
		{Method: "POST", Path: "/api/remnawave/users/bulk/{panelID}/update", Function: "bulk_update_users", Public: false},
		{Method: "POST", Path: "/api/remnawave/users/bulk/{panelID}/reset-traffic", Function: "bulk_reset_traffic", Public: false},
		{Method: "POST", Path: "/api/remnawave/users/bulk/{panelID}/revoke-subscription", Function: "bulk_revoke_subscription", Public: false},
		{Method: "POST", Path: "/api/remnawave/users/bulk/{panelID}/delete", Function: "bulk_delete_users", Public: false},
		{Method: "POST", Path: "/api/remnawave/users/bulk/{panelID}/update-squads", Function: "bulk_update_squads", Public: false},
		{Method: "POST", Path: "/api/remnawave/users/bulk/{panelID}/extend-expiration", Function: "bulk_extend_expiration", Public: false},
		{Method: "POST", Path: "/api/remnawave/users/bulk/{panelID}/all/update", Function: "bulk_update_all_users", Public: false},
		{Method: "POST", Path: "/api/remnawave/users/bulk/{panelID}/all/reset-traffic", Function: "bulk_reset_all_traffic", Public: false},
		{Method: "POST", Path: "/api/remnawave/users/bulk/{panelID}/all/extend-expiration", Function: "bulk_extend_all_expiration", Public: false},

		// --- Config profiles ---
		{Method: "GET", Path: "/api/remnawave/config-profiles/{panelID}", Function: "list_config_profiles", Public: false},
		{Method: "GET", Path: "/api/remnawave/config-profiles/{panelID}/{profileUUID}", Function: "get_config_profile", Public: false},
		{Method: "POST", Path: "/api/remnawave/config-profiles/{panelID}", Function: "create_config_profile", Public: false},
		{Method: "PATCH", Path: "/api/remnawave/config-profiles/{panelID}", Function: "update_config_profile", Public: false},
		{Method: "DELETE", Path: "/api/remnawave/config-profiles/{panelID}/{profileUUID}", Function: "delete_config_profile", Public: false},
		{Method: "GET", Path: "/api/remnawave/config-profiles/{panelID}/{profileUUID}/inbounds", Function: "get_config_profile_inbounds", Public: false},
		{Method: "GET", Path: "/api/remnawave/config-profiles/{panelID}/inbounds", Function: "get_all_inbounds", Public: false},
		{Method: "POST", Path: "/api/remnawave/config-profiles/{panelID}/reorder", Function: "reorder_config_profiles", Public: false},

		// --- Node plugins ---
		{Method: "GET", Path: "/api/remnawave/node-plugins/{panelID}", Function: "list_node_plugins", Public: false},
		{Method: "GET", Path: "/api/remnawave/node-plugins/{panelID}/{pluginUUID}", Function: "get_node_plugin", Public: false},
		{Method: "POST", Path: "/api/remnawave/node-plugins/{panelID}", Function: "create_node_plugin", Public: false},
		{Method: "PATCH", Path: "/api/remnawave/node-plugins/{panelID}", Function: "update_node_plugin", Public: false},
		{Method: "DELETE", Path: "/api/remnawave/node-plugins/{panelID}/{pluginUUID}", Function: "delete_node_plugin", Public: false},
		{Method: "POST", Path: "/api/remnawave/node-plugins/{panelID}/reorder", Function: "reorder_node_plugins", Public: false},
		...
		{Method: "PUT", Path: "/api/remnawave/metadata/{panelID}/user/{userUUID}", Function: "upsert_user_metadata", Public: false},
		{Method: "GET", Path: "/api/remnawave/metadata/{panelID}/node/{nodeUUID}", Function: "get_node_metadata", Public: false},
		{Method: "PUT", Path: "/api/remnawave/metadata/{panelID}/node/{nodeUUID}", Function: "upsert_node_metadata", Public: false},
	}
}
